...
class Game {
  ...
  addPlatforms() {
    // let x = Math.floor((Math.random() * 1400) + 1000);
    ...
    // this.platforms.push(new Platforms(1400,250,150,20));
    // this.platforms.push(new Platforms(1700,400,150,20));
    // this.platforms.push(new Platforms(2000,300,150,20));
    // this.platforms.push(new Platforms(2300,200,90,20));
